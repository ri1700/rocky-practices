...
2. 두 번째부터 수정 가능
   [/etc/NetworkManager/system-connections/enp0s3.nmconnection](https://github.com/bitacademy2025-fullstack-cloud/rocky-practices/blob/main/lx/etc/NetworkManager/system-connectios/enp0s3.nmconnection)
